...
export class InstitutionAddressService {
  ...
  // By using this method we will get the InstitutionAddress based on the Id
  GetInstitutionAddressByInstituteId(instituteId: number): any {
    return this.http.get(
      this.endpointUrl + 'GetInstitutionAddressByInstituteId/' + instituteId
    );
  }
  ...
  AddInstitutionAddress(institutionaddress: InstitutionAddress): any {
    return this.http.post(
      this.endpointUrl + 'AddInstitutionAddress',
      institutionaddress
    );
  }
  ...
  UpdateInstitutionAddress(institutionaddress: InstitutionAddress): any {
    return this.http.put(
      this.endpointUrl + 'UpdateInstitutionAddress',
      institutionaddress
    );
  }
  ...
  DeleteInstitutionAddress(id: number): any {
    return this.http.delete(
      this.endpointUrl + 'DeleteInstitutionAddress/' + id
    );
  }
